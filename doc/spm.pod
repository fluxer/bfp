...
Source and binary mode accepts base (e.g. foo), directory (e.g. /home/me/foo)
with SRCBUILD in it, aliases (e.g. base) which you can find on the top-level of
a repository as foo.alias or finally meta groups - currently only one - world.
