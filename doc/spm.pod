...
=head1 SYNOPSIS
	...
	spm [-h] [--cache CACHE] [--build BUILD] [--root ROOT]
           [--ignore IGNORE] [--demote DEMOTE] [--offline {True,False}]
           [--mirror {True,False}] [--timeout TIMEOUT] [--chost CHOST]
...
caches internally the database files in memory xand rebuilds the caches when
