...
=head1 SYNOPSIS
    ...
    mkinitfs [-h] [-t TMP] [-b BUSYBOX] [-k KERNEL]
        [-m MODULES [MODULES ...]] [-i IMAGE] [-c {gzip,cat,bzip2}]
        [-r {True,False}] [--keep] [--debug] [--version]

=head1 DESCRIPTION

MkInitfs is a initial RAM filesystem image creator.
...
optional arguments:
  ...
  -i IMAGE, --image IMAGE
                        Change output image
  -c {gzip,cat,bzip2}, --compression {gzip,cat,bzip2}
...
lsinitfs(8) scanelf(1) gzip() cpio(5) modprobe()
