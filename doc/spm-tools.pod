...
upgrade mode. It is safe to run multiple times and is ment to valuable only on
host upgrading from SPM v1.7.x. It is available on versions newer than SPM
v1.7.x.
...
positional arguments:
  {dist,check,clean,lint,sane,merge,edit,which,pack,pkg,serve,disowned,uploade,
  online,upgrade}
