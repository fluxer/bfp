...
Set wheather to verify checksums and signatures of sources files, if present.
The fetcher tries to automatically fetch those and after that compare results.
