...
_spm()
{
    ...
    local main_options repo_options remote_options source_options local_options who_options
    ...
    remote_options='-h --help -n --name -v --version -d --description -D --depends
        -m --makedepends -c --checkdepends -s --sources -o --options -b --backup -p --plain'
    
    source_options='-h --help -C --clean -p --prepare -c --compile -k --check -i --install
        -m --merge -r --remove -D --depends -R --reverse -u --update -a --automake'
    
    local_options='-h --help -n --name -v --version -d --description -D --depends -r --reverse
        -s --size -f --footprint -p --plain'
