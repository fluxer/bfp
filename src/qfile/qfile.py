...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ForwardButton = QtGui.QCommandLinkButton(self.centralwidget)
        self.ForwardButton.setGeometry(QtCore.QRect(110, 10, 41, 41))
        self.ForwardButton.setText(_fromUtf8(""))
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/usr/share/pfm/resources/forward.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/usr/share/pfm/resources/gnome-settings-ui-behavior.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.menuView.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/usr/share/pfm/resources/exit.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionQuit.setIcon(icon5)
        self.actionQuit.setObjectName(_fromUtf8("actionQuit"))
        self.actionTerminal = QtGui.QAction(MainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/usr/share/pfm/resources/utilities-terminal.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionTerminal.setIcon(icon6)
        self.actionTerminal.setObjectName(_fromUtf8("actionTerminal"))
        self.actionCopy = QtGui.QAction(MainWindow)
        self.actionCopy.setEnabled(False)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/usr/share/pfm/resources/edit-copy.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCopy.setIcon(icon7)
        self.actionCopy.setObjectName(_fromUtf8("actionCopy"))
        self.actionPaste = QtGui.QAction(MainWindow)
        self.actionPaste.setEnabled(False)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/usr/share/pfm/resources/gtk-paste.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPaste.setIcon(icon8)
        self.actionPaste.setObjectName(_fromUtf8("actionPaste"))
        self.actionCut = QtGui.QAction(MainWindow)
        self.actionCut.setEnabled(False)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/usr/share/pfm/resources/editcut.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCut.setIcon(icon9)
        self.actionCut.setObjectName(_fromUtf8("actionCut"))
        self.actionAbout = QtGui.QAction(MainWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8(":/usr/share/pfm/resources/stock_view-details.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAbout.setIcon(icon10)
        self.actionAbout.setObjectName(_fromUtf8("actionAbout"))
        self.actionDelete = QtGui.QAction(MainWindow)
        self.actionDelete.setEnabled(False)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8(":/usr/share/pfm/resources/editdelete.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(_fromUtf8(":/usr/share/pfm/resources/stock_properties.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionProperties.setIcon(icon12)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(_fromUtf8(":/usr/share/pfm/resources/archive-extract.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCompress.setIcon(icon13)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(_fromUtf8(":/usr/share/pfm/resources/cab_extract.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDecompress.setIcon(icon14)
        self.actionDecompress.setObjectName(_fromUtf8("actionDecompress"))
        self.actionIcons = QtGui.QAction(MainWindow)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(_fromUtf8(":/usr/share/pfm/resources/plugin-scale.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionIcons.setIcon(icon15)
        self.actionIcons.setObjectName(_fromUtf8("actionIcons"))
        self.actionList = QtGui.QAction(MainWindow)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(_fromUtf8(":/usr/share/pfm/resources/edit-select-all.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionList.setIcon(icon16)
        self.actionList.setObjectName(_fromUtf8("actionList"))
        self.actionPreferences = QtGui.QAction(MainWindow)
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(_fromUtf8(":/usr/share/pfm/resources/redhat-tools.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(_fromUtf8(":/usr/share/pfm/resources/edit-rename.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRename.setIcon(icon18)
        ...
        self.menuActions.addAction(self.actionTerminal)
        self.menuActions.addAction(self.actionCompress)
        self.menuActions.addAction(self.actionDecompress)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionCompress.setText(_translate("MainWindow", "Compress", None))
